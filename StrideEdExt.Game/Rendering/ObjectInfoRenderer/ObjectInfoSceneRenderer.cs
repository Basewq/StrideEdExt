...
public class ObjectInfoSceneRenderer : SceneRendererBase
{
    ...
    public RenderStage ObjectInfoRenderStage { get; set; } = default!;

    protected override void Unload()
    {
        base.Unload();

        DisposableExtensions.DisposeAndNull(ref _objectInfoTexture);
    }
    ...
    protected override void DrawCore(RenderContext context, RenderDrawContext drawContext)
    {
        ...
        if (_objectInfoTexture is null
            || _objectInfoTexture.Width != viewWidth || _objectInfoTexture.Height != viewHeight)
        {
            _objectInfoTexture?.Dispose();
        ...
        foreach (var renderFeature in drawContext.RenderContext.RenderSystem.RenderFeatures)
        {
            ...
            foreach (var viewLayout in viewFeature.Layouts)
            {
                ...
                if (objectInfoLogicalGroup.Hash == default)
                {
                    continue;
                }
