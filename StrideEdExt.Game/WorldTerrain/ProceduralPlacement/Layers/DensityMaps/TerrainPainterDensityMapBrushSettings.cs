...
[DataContract]
public enum ObjectDensityMapPaintModeType
{
    Paint,
    Erase
}
...
[DataContract]
public class TerrainPainterDensityMapBrushSettings
{
    private ObjectDensityMapPaintModeType _paintModeType;
    public ObjectDensityMapPaintModeType PaintModeType { get => _paintModeType; set => SetValue(ref _paintModeType, value); }
