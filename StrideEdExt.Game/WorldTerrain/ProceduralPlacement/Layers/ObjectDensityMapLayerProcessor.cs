...
class ObjectDensityMapLayerProcessor : EntityProcessor<ObjectDensityMapLayerComponentBase, ObjectDensityMapLayerProcessor.AssociatedData>
{
#if GAME_EDITOR
    private SceneEditorGame _sceneEditorGame = default!;
#endif

    public ObjectDensityMapLayerProcessor()
    {
    ...
    protected override AssociatedData GenerateComponentData([NotNull] Entity entity, [NotNull] ObjectDensityMapLayerComponentBase component)
    {
    ...
    protected override bool IsAssociatedDataValid([NotNull] Entity entity, [NotNull] ObjectDensityMapLayerComponentBase component, [NotNull] AssociatedData data)
    {
        return true;
    }

    protected override void OnEntityComponentAdding(Entity entity, [NotNull] ObjectDensityMapLayerComponentBase component, [NotNull] AssociatedData data)
    {
    ...
    protected override void OnEntityComponentRemoved(Entity entity, [NotNull] ObjectDensityMapLayerComponentBase component, [NotNull] AssociatedData data)
    {
        component.Deinitialize();
        if (component.EditorComponent is ObjectPlacementMapEditorComponent editorComp)
        {
            if (editorComp.ActiveDensityMapLayerComponent == component)
            {
