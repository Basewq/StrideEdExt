...
class ProceduralObjectPlacementProcessor : EntityProcessor<ProceduralObjectPlacementComponent, ProceduralObjectPlacementProcessor.AssociatedData>
{
#if GAME_EDITOR
    private SceneEditorGame _sceneEditorGame = default!;
#endif

    public ProceduralObjectPlacementProcessor()
    {
    ...
    protected override AssociatedData GenerateComponentData([NotNull] Entity entity, [NotNull] ProceduralObjectPlacementComponent component)
    {
    ...
    protected override bool IsAssociatedDataValid([NotNull] Entity entity, [NotNull] ProceduralObjectPlacementComponent component, [NotNull] AssociatedData data)
    {
        return true;
    }

    protected override void OnEntityComponentAdding(Entity entity, [NotNull] ProceduralObjectPlacementComponent component, [NotNull] AssociatedData data)
    {
        component.Initialize(Services);
    }

    protected override void OnEntityComponentRemoved(Entity entity, [NotNull] ProceduralObjectPlacementComponent component, [NotNull] AssociatedData data)
    {
